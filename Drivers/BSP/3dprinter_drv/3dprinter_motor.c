...
void BSP_MotorControlBoard_GpioInit(uint8_t nbDevices) {
	...
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_CS_PORT,
			BSP_MOTOR_CONTROL_BOARD_CS_PIN, GPIO_PIN_SET);
...
void BSP_MotorControlBoard_PwmXSetFreq(uint16_t newFreq) {
	...
	uint32_t period = (sysFreq
			/ (TIMER_PRESCALER
					* BSP_MOTOR_CONTROL_BOARD_TIMER_PWM_X_FREQ_RESCALER
					* (uint32_t) newFreq)) - 1;
...
void BSP_MotorControlBoard_PwmYSetFreq(uint16_t newFreq) {
	...
	uint32_t period = (sysFreq
			/ (TIMER_PRESCALER
					* BSP_MOTOR_CONTROL_BOARD_TIMER_PWM_Y_FREQ_RESCALER
					* (uint32_t) newFreq)) - 1;
...
void BSP_MotorControlBoard_PwmE3SetFreq(uint16_t newFreq) {
	...
	uint32_t period = (sysFreq
			/ (TIMER_PRESCALER
					* BSP_MOTOR_CONTROL_BOARD_TIMER_PWM_E3_FREQ_RESCALER
					* (uint32_t) newFreq)) - 1;
...
void BSP_MotorControlBoard_ReleaseReset(void) {
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_X_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_X_PIN, GPIO_PIN_SET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_Y_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_Y_PIN, GPIO_PIN_SET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_Z_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_Z_PIN, GPIO_PIN_SET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_E1_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_E1_PIN, GPIO_PIN_SET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_E2_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_E2_PIN, GPIO_PIN_SET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_E3_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_E3_PIN, GPIO_PIN_SET);
}
...
void BSP_MotorControlBoard_Reset(void) {
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_X_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_X_PIN, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_Y_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_Y_PIN, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_Z_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_Z_PIN, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_E1_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_E1_PIN, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_E2_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_E2_PIN, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_RESET_E3_PORT,
			BSP_MOTOR_CONTROL_BOARD_RESET_E3_PIN, GPIO_PIN_RESET);
}
...
void BSP_MotorControlBoard_SetDirectionGpio(uint8_t deviceId, uint8_t gpioState) {
	switch (deviceId) {
	case 5:
		HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_DIR_E3_PORT,
				BSP_MOTOR_CONTROL_BOARD_DIR_E3_PIN, (GPIO_PinState) gpioState);
		break;
	case 4:
		HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_DIR_E2_PORT,
				BSP_MOTOR_CONTROL_BOARD_DIR_E2_PIN, (GPIO_PinState) gpioState);
		break;
	case 3:
		HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_DIR_E1_PORT,
				BSP_MOTOR_CONTROL_BOARD_DIR_E1_PIN, (GPIO_PinState) gpioState);
		break;
	case 2:
		HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_DIR_Z_PORT,
				BSP_MOTOR_CONTROL_BOARD_DIR_Z_PIN, (GPIO_PinState) gpioState);
		break;
	case 1:
		HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_DIR_Y_PORT,
				BSP_MOTOR_CONTROL_BOARD_DIR_Y_PIN, (GPIO_PinState) gpioState);
		break;
	case 0:
		HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_DIR_X_PORT,
				BSP_MOTOR_CONTROL_BOARD_DIR_X_PIN, (GPIO_PinState) gpioState);
		break;
	default:
		;
	}
...
uint8_t BSP_MotorControlBoard_SpiWriteBytes(uint8_t *pByteToTransmit,
	...
	uint32_t i;
	HAL_GPIO_WritePin(BSP_MOTOR_CONTROL_BOARD_CS_PORT,
			BSP_MOTOR_CONTROL_BOARD_CS_PIN, GPIO_PIN_RESET);
